...
def qubit_hamiltonian(geometry, basis):
    jlgeometry = Geometry(geometry)
    pauli_op = Main.qubit_hamiltonian(jlgeometry, basis)
    spop_jl = QiskitQuantumInfo.SparsePauliOp(pauli_op)
    spop = jlSparsePauliOp(spop_jl)
    return spop
